...
routes.post('/products', productController.postCreate)
//rota get para acessar os produtos e retornar os valores presentes nesse arquivo
routes.get('/products', productController.getReadProduct)
...
routes.get('/products-stock-value', productController.getStockSum)
